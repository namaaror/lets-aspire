...
var loadStyle = _useStyle2.load;
var _useStyle22 = useStyle("", {
  name: "global",
  manual: true
});
var loadGlobalStyle = _useStyle22.load;
var script = {
  name: "BaseComponent",
  props: {
    pt: {
  ...
  methods: {
    ...
    _getPTValue: function _getPTValue() {
      ...
      var _ref3 = this._getPropValue("ptOptions") || {}, _ref3$mergeSections = _ref3.mergeSections, mergeSections = _ref3$mergeSections === void 0 ? true : _ref3$mergeSections, _ref3$mergeProps = _ref3.mergeProps, useMergeProps = _ref3$mergeProps === void 0 ? false : _ref3$mergeProps;
      ...
      var self = searchOut ? void 0 : this._usePT(this._getPT(obj, this.$name), this._getPTClassValue, key, _objectSpread(_objectSpread({}, params), {}, {
        global: global || {}
      }));
    ...
    cx: function cx() {
      var key = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
      var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      return !this.isUnstyled ? this._getOptionValue(this.$css.classes, key, _objectSpread(_objectSpread({}, this.$params), params)) : void 0;
    },
    sx: function sx() {
      var key = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
...
//# sourceMappingURL=chunk-DB5IMHN6.js.map
